...
from todos.utils import error_for_list_title, find_list_by_id, error_for_todo, find_todo_by_id, delete_todo_by_id, mark_all_completed, todos_remaining, is_list_completed, sort_items, is_todo_completed
...
def update_list(lst, list_id):
    ...
    if error:
        flash(error, "error")
        return render_template("edit_list.html", lst=lst, new_title=new_title)
