// https://launchschool.com/lessons/08996120/assignments/9b319c10
...
//   console.log(sortedArray[sortedArray.length - 1].split(' '));
// }
...
function longestSentence(text) {
  ...
  let longestSentence = sortedArray[0].split(' ').length;
